...
namespace SuperM.UI.WinForm {
    ...
    public partial class Products : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductsRow AddProductsRow(string Name, decimal Price, string Description, string Category) {
...
namespace SuperM.UI.WinForm.ProductsTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Name], [Price], [Description], [Category]) VALUES " +
                "(@Name, @Price, @Description, @Category);\r\nSELECT ProductId, Name, Price, Descri" +
                "ption, Category FROM Products WHERE (ProductId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Name] = @Name, [Price] = @Price, [Description] = @Description, [Category] = @Category WHERE (([ProductId] = @Original_ProductId) AND ([Price] = @Original_Price));
SELECT ProductId, Name, Price, Description, Category FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=.;Initial Catalog=SuperMDB;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, Name, Price, Description, Category FROM dbo.Products";
        ...
        public virtual int Insert(string Name, decimal Price, string Description, string Category) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, decimal Price, string Description, string Category, int Original_ProductId, decimal Original_Price, int ProductId) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Price, string Description, string Category, int Original_ProductId, decimal Original_Price) {
            return this.Update(Name, Price, Description, Category, Original_ProductId, Original_Price, Original_ProductId);
        }
    }
